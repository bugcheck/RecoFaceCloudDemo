...
import com.reconova.facecloud.util.DisplayUtil;
...
public class FaceView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		//int screenHeight = DisplayUtil.getScreenMetrics(getContext()).y;
		DisplayUtil.prepareMatrix(mMatrix, isMirror, 90, getWidth(), getHeight());
